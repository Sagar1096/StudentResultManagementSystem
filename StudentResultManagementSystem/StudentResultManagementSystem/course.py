...
#=============================
    ...
    def get_data(self,ev):
       ...
       self.var_discription.set(row[4])
       self.txt_description.delete('1.0',END)
      ...
      try:
         if self.var_course.get()=="":
            ...
            if row!=None:
               ...
               cur.execute("insert  into course (name,duration,charges,discription)values(?,?,?,?)",(
                  self.var_course.get(),
      ...
      try:
         if self.var_course.get()=="":
            ...
            if row==None:
               ...
               cur.execute("update course set duration=?,charges=?,discription=? where name=?",(
