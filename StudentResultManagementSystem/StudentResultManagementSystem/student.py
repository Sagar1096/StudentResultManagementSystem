...
class studentClass:
    ...
    #=================entry_fields==============
      ...
      #===============column 2==================
       ...
       lbl_a_date=Label(self.root,text="Addmission",font=("goudy old style",15,'bold'),bg='white').place(x=360,y=140)
    ...
    #===========search panel============
       ...
       txt_search_roll=Entry(self.root,textvariable=self.var_roll,font=("goudy old style",15,'bold'),bg='lightyellow').place(x=870,y=60,width=180)
       btn_add=Button(self.root,text='Search',font=("goudy old style",15,"bold"),bg="#2196f3",fg="white",cursor="hand2",command=self.search).place(x=1070,y=60,width=120,height=28)
      ...
      try:
         if self.var_roll.get()=="":
            ...
            if row==None:
               ...
               op=messagebox.askyesno("Confirm","Do you really went to delete?",parent=self.root)
               if op==True:
